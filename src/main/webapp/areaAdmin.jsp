...
<html lang="es">
    <head>
        ...
        <title>CineWeb - Área de Administrador</title>
    ...
    <body>
        <%
            ...
            Usuario administador = (Usuario) session.getAttribute("usuario");
        ...
        <nav class="navbar navbar-dark bg-dark">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu text-center">
                    <a><%=administador.getNombre()%></a>
                    <a><%=administador.getEmail()%></a>
        ...
        <header>
            <h1>Bienvenido a tu Área de Administrador</h1>
        </header>

        <section>
            <h2>Datos del Usuario</h2>
            <p><strong>Nombre:</strong> <%= administador.getNombre() %></p>
            <p><strong>Email:</strong> <%= administador.getEmail() %></p>
            <p><strong>Tipo de Usuario:</strong> <%= administador.getTipoUsuario() %></p>
